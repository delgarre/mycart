                        ...
                        <div class="dropdown show">
                            <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             ...
                             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="vendor_only_report.jsp">REMOVE DESCRIPTION</a>
                            </div>
                        </div>
                        <br>
                            <button class="btn btn-success" onclick="add()">ADD VENDOR</button>
                            <button class="btn btn-danger" onclick="remove()">REMOVE VENDOR</button>
                            <form action="vendor_report_page.jsp" method="post">
