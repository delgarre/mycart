                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card-body">
                        <%@include file="components/message.jsp" %>
                            ...
                            <form action="order_report_3_locations_page.jsp" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="location" type="text" class="form-control" id="location" placeholder="Enter a location">
                                </div>
                                
                                <div class="form-group">
                                  <label for="location2">LOCATION 2:</label>
                                  <input name="location2" type="text" class="form-control" id="location2" placeholder="Enter a number">
                                </div>
