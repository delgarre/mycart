...
if(contactInfo.equals("Yes")){
    ...
    response.sendRedirect("save_pharm.jsp?id="+id+"&name="+name+"&user_id="+user_id+"&itemNumber="+itemNumber+"&locations="+locations+"&stat="+stat+"&quantity="+quantity+"&department="+department);
}
%>
