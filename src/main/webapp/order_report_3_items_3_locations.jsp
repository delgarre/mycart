                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card-body">
                        <%@include file="components/message.jsp" %>
                            ...
                            <form action="order_report_3_item_3_loc_page.jsp" method="post">
                                ...
                                <div class="form-group">
                                  <label for="itemNumber3">Item Number 3:</label>
                                  <input name="itemNumber3" type="text" class="form-control" id="itemNumber3" placeholder="Enter item number">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="location2" type="text" class="form-control" id="location2" placeholder="Enter vendor name">
                                </div>
                                
                                <div class="form-group">
                                  <label for="location3">Location:</label>
                                  <input name="location3" type="text" class="form-control" id="location3" placeholder="Enter vendor name">
                                </div>
