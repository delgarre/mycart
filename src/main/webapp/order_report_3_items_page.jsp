...
%>
<%
String itemNumbers = request.getParameter("itemNumber");
...
String sql ="select * from OrderHistory where date between '"+date1+"' and '"+date2+"' and itemNumber = '"+itemNumbers+"' or itemNumber = '"+itemNumber2+"' or itemNumber = '"+itemNumber3+"'";
