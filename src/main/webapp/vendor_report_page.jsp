...
String sql ="select * from OrderHistory where date between '"+date1+"' and '"+date2+"' and FIND_IN_SET(locations,'"+chooselocations+"' ) and pDesc like '%"+pDescs+"%' and FIND_IN_SET(vTitle,'"+itemsList+"' )";
