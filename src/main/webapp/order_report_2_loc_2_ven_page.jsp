...
String sql ="select * from OrderHistory where date between '"+date1+"' and '"+date2+"' and vTitle = '"+vendor1+"' or vTitle = '"+vendor2+"' and locations = '"+location+"' or locations = '"+location2+"'";
