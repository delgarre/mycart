                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card-body">
                        <%@include file="components/message.jsp" %>
                            ...
                            <form action="order_report_3_loc_3_ven_page.jsp" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="location" type="text" class="form-control" id="location" placeholder="Enter item number">
                                </div>
                                
                                <div class="form-group">
                                  <label for="location2">Location 2:</label>
                                  <input name="location2" type="text" class="form-control" id="location2" placeholder="Enter item number">
                                </div>
                                
                                <div class="form-group">
                                  <label for="location3">Location 3:</label>
                                  <input name="location3" type="text" class="form-control" id="location3" placeholder="Enter item number">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="vendor3" type="text" class="form-control" id="vendor3" placeholder="Enter vendor name">
                                </div>
