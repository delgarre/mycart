                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card-body">
                        <%@include file="components/message.jsp" %>
                            ...
                            <form action="order_report_3_ven_page.jsp" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="vendor" type="text" class="form-control" id="vendor" placeholder="Enter item number">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="vendor3" type="text" class="form-control" id="vendor3" placeholder="Enter item number">
                                </div>
