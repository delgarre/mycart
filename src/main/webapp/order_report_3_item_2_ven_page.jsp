...
String sql ="select * from OrderHistory where date between '"+date1+"' and '"+date2+"' and vTitle = '"+vendor1+"' or vTitle = '"+vendor2+"' and itemNumber = '"+itemNumber1+"' or itemNumber = '"+itemNumber2+"' or itemNumber = '"+itemNumber3+"'";
