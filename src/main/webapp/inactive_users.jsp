    ...
    <body>
        ...
        <div class="center">
         ...
         <div class="row ml-2">
            ...
            <div class="row ml-2">
            <a href="users.jsp">
                <button class="btn btn-outline-success">ACTIVE USERS</button>
            </a>
        </div>
        ...
        <table class="table table-bordered table-fit" >
            ...
            <%
                ...
                List<User> ulist = uDao.getInactiveUsers();
            ...
            <tr>
                ...
                <td><%= u.getUserType()%></td>
                <td>
                    <a href="reactivate_user.jsp?id=<%= u.getUserId() %>" onclick="return confirm('Are you sure?');">
                        <button type="button" class="btn btn-outline-danger">REACTIVATE</button>
                    </a>
