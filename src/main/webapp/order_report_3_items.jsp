                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card-body">
                        <%@include file="components/message.jsp" %>
                            ...
                            <form action="order_report_3_items_page.jsp" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="itemNumber" type="text" class="form-control" id="itemNumber" placeholder="Enter item number">
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="itemNumber3">ITEM NUMBER 2:</label>
